...
class TheSearch:
    ...
    def __init__(self, what, where, age=Filters.Age.ALL, radius=Filters.Radius.ALL, experience=Filters.Experience.ALL,
    ...
    def flip_pages(self):
        ...
        pages.append(page0)
        page_count = math.ceil(page0.job_count / TheSearch.JOBS_ON_PAGE)
        print(page_count)
        if page_count > 1:
